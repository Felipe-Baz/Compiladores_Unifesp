...
{
       0,   242,   242,   255,   259,   265,   266,   271,   294,   296,
     300,   315,   300,   355,   356,   360,   361,   365,   389,   407,
     408,   412,   435,   444,   448,   458,   462,   463,   464,   465,
     466,   470,   471,   476,   476,   510,   518,   519,   523,   529,
     539,   548,   560,   575,   590,   606,   610,   617,   621,   621,
     621,   621,   621,   621,   625,   630,   634,   639,   647,   652,
     656,   661,   669,   670,   684,   684,   714,   730,   735,   742,
     743,   747,   751
};
#endif
...
#line 590 "parser.y"
    {
          ...
          idNode->name = strdup((yyvsp[(1) - (6)].sval));
          addChild(assignNode, idNode);
          addChild(assignNode, (yyvsp[(3) - (6)].node));
...
#line 610 "parser.y"
    {
        ...
        addChild(opNode, (yyvsp[(1) - (3)].node));
        addChild(opNode, (yyvsp[(3) - (3)].node));
        (yyval.node) = opNode;
      ;}
    break;
...
#line 714 "parser.y"
    {
          ...
          TreeNode* idNode = createNode(NODE_ID);
          idNode->name = strdup((yyvsp[(1) - (4)].sval));
          (yyval.node) = idNode;
